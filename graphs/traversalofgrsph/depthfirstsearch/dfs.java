...
public class dfs {
    ...
    // public static void dfs(ArrayList<Edge> graph[], int V, boolean visited[], int start) {
    //     if (visited[start] == false) {
    //         System.out.print(start + " ");
    //         visited[start] = true;
    //         for (int i = 0; i < graph[start].size(); i++) {
    //             Edge e = graph[start].get(i);
    //             dfs(graph, V, visited, e.dest);
    //         }
    //     }
    // }

    // public static void dfstwo(ArrayList<Edge> graph[], int curr, boolean visited[]) {
    //     System.out.print(curr + " ");
    //     visited[curr] = true;
    //     for (int i = 0; i < graph[curr].size(); i++) {
    //         Edge e = graph[curr].get(i);
    //         if (visited[e.dest] == false) {
    //             dfstwo(graph, e.dest, visited);
    //         }
    //     }
    // }
    ...
    public static void main(String[] args) {
        ...
        // System
        dfsallpath(graph, new boolean[V], 0, 5, "");
    }
}
